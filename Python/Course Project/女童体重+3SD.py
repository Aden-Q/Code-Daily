...
f = [4.65, 6.05, 7.46, 8.71, 9.66, 10.38, 10.93, 11.4, 11.8, 12.18, 12.52, 12.85, 13.15, 14.02, 14.9, 15.85, 16.77, 17.63, 18.47, 19.29, 20.1, 20.9, 21.69,
     22.49, 23.3, 24.14, 25.04, 25.96, 26.87, 27.84, 28.89, 29.95, 30.94, 32, 33.14, 34.4]
for i in range(1, 36):
