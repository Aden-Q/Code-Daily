...
f = [4.1, 5.35, 6.6, 7.73, 8.59, 9.23, 9.73, 10.15, 10.51, 10.86, 11.16, 11.46, 11.73, 12.5, 13.29, 14.12, 14.92, 15.67, 16.39, 17.11, 17.81, 18.5, 19.17,
     19.85, 20.54, 21.25, 22, 22.75, 23.5, 24.28, 25.12, 25.96, 26.74, 27.57, 28.46, 29.42]
for i in range(1, 36):
