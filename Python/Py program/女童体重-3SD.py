...
f = [2.26, 2.98, 3.72, 4.4, 4.93, 5.33, 5.64, 5.9, 6.13, 6.34, 6.53, 6.71, 6.87, 7.34, 7.79, 8.26, 8.7, 9.1, 9.48, 9.86, 10.23, 10.6, 10.95,
     11.29, 11.62, 11.96, 12.3, 12.62, 12.93, 13.23, 13.54, 13.84, 14.11, 14.38, 14.66, 14.96]
for i in range(1, 36):
